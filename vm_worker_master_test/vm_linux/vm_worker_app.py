...
# 导入thrift定义的模块
from gen_vm_worker.vm_worker import VMWorker  # vm service
from gen_vm_worker.vm_worker.ttypes import *  # vm struct

from gen_executor.worker.Worker import Client
...
class VMWorkerApp:
    ...
    #安装应用
    def AppIntallWorker(self, id, install_dir):
	...
	try :
                ...
                executor_client.AppInstalled(job_id, task_id, id)
