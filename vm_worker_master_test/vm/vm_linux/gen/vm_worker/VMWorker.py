...
class Client(Iface):
  ...
  def StopApp4Daemon(self, id):
    ...
    Parameters:
     - id
    """
    self.send_StopApp4Daemon(id)
    return self.recv_StopApp4Daemon()

  def send_StopApp4Daemon(self, id):
    self._oprot.writeMessageBegin('StopApp4Daemon', TMessageType.CALL, self._seqid)
    args = StopApp4Daemon_args()
    args.id = id
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_StopApp4Daemon(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = StopApp4Daemon_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "StopApp4Daemon failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["StopApp4Daemon"] = Processor.process_StopApp4Daemon
  ...
  def process_StopApp4Daemon(self, seqid, iprot, oprot):
    args = StopApp4Daemon_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = StopApp4Daemon_result()
    result.success = self._handler.StopApp4Daemon(args.id)
    oprot.writeMessageBegin("StopApp4Daemon", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class InstallApp_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'app_info', (VM_AppInfo, VM_AppInfo.thrift_spec), None, ), # 1
  )
...
class StopApp4Daemon_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('StopApp4Daemon_args')
    if self.id is not None:
      oprot.writeFieldBegin('id', TType.I32, 1)
      oprot.writeI32(self.id)
      oprot.writeFieldEnd()
...
class StopApp4Daemon_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('StopApp4Daemon_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
